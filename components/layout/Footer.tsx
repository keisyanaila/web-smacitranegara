        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 40, marginBottom: 40 }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              ...
              <div>
                <div style={{ fontWeight: 800, fontSize: 15 }}>SMA Citra Negara</div>
            ...
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 1.7, marginBottom: 20 }}>
              Sekolah Menengah Atas Citra Negara.
            </p>
            <div style={{ display: 'flex', gap: 12 }}>
 <a
  href="https://www.instagram.com/smacitranegara?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
  target="_blank"
...
<a
  href="https://www.tiktok.com/@smacnmantap?is_from_webapp=1&sender_device=pc"
  target="_blank"
  rel="noopener noreferrer"
  style={{
    width: 40,
  ...
  <FaWhatsapp size={18} />
          ...
          <div>
            ...
            {[
              ...
              { href: '/jurusan', label: 'Bidang studi' },
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>
            © 2026 SMA Citra Negara. All rights reserved.
          </p>
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>
